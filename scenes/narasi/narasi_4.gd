...
const TOTAL_DURATION_SECONDS: float = 9.0
const NEXT_SCENE_PATH := "res://scenes/line/line4.tscn" # UBAH sesuai path kamu
...
func _on_timer_timeout() -> void:
	print("Waktu 11 detik selesai. Scene siap untuk transisi.")
